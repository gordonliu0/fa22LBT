...
namespace fa22LBT.Migrations
{
    ...
    [Migration("20221129202436_blah27")]
    partial class blah27
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("fa22LBT.Models.StockPortfolio", b =>
                {
                    ...
                    b.Property<string>("BankAccountForeignKey")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("BankAccountForeignKey")
                        .IsUnique()
                        .HasFilter("[BankAccountForeignKey] IS NOT NULL");
            ...
            modelBuilder.Entity("fa22LBT.Models.StockPortfolio", b =>
                {
                    ...
                    b.HasOne("fa22LBT.Models.BankAccount", "BankAccount")
                        .WithOne("StockPortfolio")
                        .HasForeignKey("fa22LBT.Models.StockPortfolio", "BankAccountForeignKey");
