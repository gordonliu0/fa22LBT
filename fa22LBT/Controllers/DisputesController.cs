    ...
    public class DisputesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Disputes != null ? 
                          View(await _context.Disputes.ToListAsync()) :
        ...
        public async Task<IActionResult> Create([Bind("DisputeID,DisputeDescription,CorrectAmount,DisputeStatus")] Dispute dispute)
        {
